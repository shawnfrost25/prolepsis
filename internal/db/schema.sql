...
CREATE TABLE users (
    ...
    CONSTRAINT users_gender_check CHECK (gender IN ('male', 'female', 'prefer_not_to_specify')),
    location TEXT,
...
CREATE TABLE pending_registrations (
    ...
    gender TEXT NOT NULL,
    CONSTRAINT pending_registrations_gender_check CHECK (gender IN ('male', 'female', 'prefer_not_to_specify')),
    birth_date DATE NOT NULL,
    email TEXT NOT NULL,
